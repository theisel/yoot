...
[Home](/docs/README.md) &gt; [API Reference](/docs/api/README.md) &gt; [@yoot/yoot](./yoot.md) &gt; [html](./yoot.html.md) &gt; <span style="opacity:0.7;font-style:italic">withSourceAttrs</span>

## html.withSourceAttrs() function
...
(yoot: [Yoot](./yoot.yoot.md)<!-- -->, overrideOptions?: [SourceAttrsOptions](./yoot.jsx.sourceattrsoptions.md)<!-- -->) =&gt; SourceAttrs
